...
from data.VSDataset import VSDataset, VSNPDataset
...
train_transforms_bf = aug.Compose(
    [
        aug.RandomCrop(1024, 1024),
        aug.Resize(512, 512),
        aug.Flip(),
