...
from data.VSDataset import VSDataset, VSNPDataset, VSNPMTLDataset
...
train_transforms = aug.Compose(
    [
        aug.RandomCrop(1024, 1024),aug.Resize(512, 512),
        aug.RandomGridShuffle(grid=(4, 4), p=0.5),
        aug.Flip(),
        aug.RandomRotate90(),
...
valid_transforms = aug.Compose([aug.Resize(512, 512)])
